...
push_image="${registry_push}/p2ppsr/leaderlib-server:${image_tag}"
pull_image="${registry_pull}/p2ppsr/leaderlib-server:${image_tag}"

docker build -t "${push_image}" -f packages/server/Dockerfile .
